...
import { mySidebarService } from './sidebar.service';
...
export class mySidebarComponent implements OnInit, OnDestroy
{
    // Name
    @Input()
    name: string;
    ...
    ngOnInit(): void
    {
        ...
        this._mySidebarService.register(this.name, this);
    ...
    ngOnDestroy(): void
    {
        ...
        this._mySidebarService.unregister(this.name);
    ...
    private _showBackdrop(): void
    {
        ...
        this._backdrop.classList.add('my-sidebar-overlay');

        // Add a class depending on the invisibleOverlay option
        if ( this.invisibleOverlay )
        {
            this._backdrop.classList.add('my-sidebar-overlay-invisible');
        }
